...
[![v1.0.0](https://img.shields.io/badge/version-v1.0.0-lightgray.svg?style=flat&logo=)](https://github.com/thingnoy/wc-datepicker/blob/main/CHANGELOG.md) [![](https://img.shields.io/npm/v/@thingnoy/wc-datepicker?color=CC3534&logo=npm)](https://www.npmjs.com/package/@thingnoy/wc-datepicker) [![License: MIT](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat&logo=license)](https://github.com/thingnoy/wc-datepicker/blob/main/LICENSE.md) [![Powered By Svelte](https://img.shields.io/badge/powered%20by-svelte-FF3C02.svg?style=flat&logo=svelte)](https://svelte.dev/) [![Language: TypeScript](https://img.shields.io/badge/language-typescript-blue.svg?style=flat&logo=typescript)](https://www.typescriptlang.org/) [![ECMAScript: 2019](https://img.shields.io/badge/ES-9-F7DF1E.svg?style=flat&logo=javascript)](https://github.com/tc39/ecma262) [![Discord Server](https://discordapp.com/api/guilds/383373985666301975/embed.png)](https://discord.ptkdev.io)

<!-- all-shields/header-badges:END -->

Svelte WebComponent DatePicker.

This is a [github template](https://github.blog/2019-06-06-generate-new-repositories-with-repository-templates/), you can fork it or [use as template](https://github.com/thingnoy/wc-datepicker/generate) for start new project with this repository as hello-world. I hate start new project with empty template, often i missing correct configuration, readme instruction or i need of samples of code. Use this repository as template solve this problem.
...
-   🐛 [Known Bugs](https://github.com/thingnoy/wc-datepicker/issues?q=is%3Aopen+is%3Aissue+label%3Abug)
-   🍻 Community:
    -   <img src="https://raw.githubusercontent.com/thingnoy/wc-datepicker/wc-datepicker/main/.github/assets/social_telegram.png" height="18px"> Telegram ([🇬🇧 English](http://t.me/ptkdev_support) | [🇮🇹 Italian](http://t.me/ptkdev_support_italian))
    -   <img src="https://raw.githubusercontent.com/thingnoy/wc-datepicker/wc-datepicker/main/.github/assets/social_discord.png" height="18px"> [Discord](http://discord.ptkdev.io) ([🇬🇧 English](https://discord.gg/jqUSGPKdmA) | [🇮🇹 Italian](https://discord.gg/SJFcbvG6RU) | [🇵🇱 Polish](https://discord.gg/25vg4VFhb7))
    -   <img src="https://raw.githubusercontent.com/thingnoy/wc-datepicker/wc-datepicker/main/.github/assets/social_twitter.png" height="18px"> [Twitter](http://twitter.com/ptkdevio)
...
[![](https://raw.githubusercontent.com/thingnoy/wc-datepicker/wc-datepicker/main/.github/assets/screenshot.png)](https://raw.githubusercontent.com/thingnoy/wc-datepicker/wc-datepicker/main/.github/assets/screenshot.png)
...
```html
<wc-datepicker header="make" flip="svelte,webcomponents,opensource" footer="awesome!"></wc-datepicker>
```

2. Require javascript in yourpage (before `</body>`):

```html
<script src="https://cdn.jsdelivr.net/npm/@thingnoy/wc-datepicker@latest/dist/webcomponent.js"></script>
```
...
1. Install npm module: `npm install @thingnoy/wc-datepicker --save`
...
```javascript
require("@thingnoy/wc-datepicker");
```

or

```javascript
import "@thingnoy/wc-datepicker";
```
...
1. Download wordpress plugin from [mirror](https://cdn.jsdelivr.net/npm/@thingnoy/wc-datepicker@latest/dist/wordpress/wc-datepicker-wordpress-plugin.zip) and install it.
...
1. Install npm module with `npm install @thingnoy/wc-datepicker@latest --save`:
...
Vue.config.ignoredElements = ["wc-datepicker"];
```
...
1. Clone this repository or download [nightly](https://github.com/thingnoy/wc-datepicker/archive/nightly.zip), [beta](https://github.com/thingnoy/wc-datepicker/archive/beta.zip) or [stable](https://github.com/thingnoy/wc-datepicker/archive/main.zip).
2. Run `npm install`
3. Run `npm run dev`
...
Thanks to all our backers! 🙏 Donate 3$ or more on [paypal](https://www.paypal.me/ptkdev), [ko-fi](https://ko-fi.com/ptkdev), [github](https://github.com/sponsors/ptkdev) or [patreon](https://www.patreon.com/join/ptkdev) and send me [email](mailto:boyskypart@gmail.com) with your avatar and url.
...
<table>
  <tr>
    <td align="center"><a href="https://ptk.dev"><img src="https://avatars1.githubusercontent.com/u/442844?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Patryk Rzucidło</b></sub></a><br /><a href="https://github.com/thingnoy/thingnoy/wc-datepicker/commits?author=ptkdev" title="Code">💻</a> <a href="#translation-ptkdev" title="Translation">🌍</a> <a href="https://github.com/thingnoy/thingnoy/wc-datepicker/commits?author=ptkdev" title="Documentation">📖</a> <a href="https://github.com/thingnoy/thingnoy/wc-datepicker/issues?q=author%3Aptkdev" title="Bug reports">🐛</a></td>
  </tr>
</table>
...
[![](https://img.shields.io/badge/%F0%9F%A6%92%20Tools-Node%20Logger-9b59b6.svg?style=flat&logo=)](https://github.com/thingnoy/wc-datepicker/ptkdev-logger) [![](https://img.shields.io/badge/%F0%9F%A6%8C%20Tools-All%20Shields%20CLI-9b59b6.svg?style=flat&logo=)](https://github.com/thingnoy/wc-datepicker/all-shields-cli) [![](https://img.shields.io/badge/%F0%9F%96%A5%EF%B8%8F%20Tools-Aspect%20Ratio%2021%3A9-9b59b6.svg?style=flat&logo=)](https://github.com/thingnoy/wc-datepicker/chrome-extension-aspectratio219) [![](https://img.shields.io/badge/%F0%9F%9B%A1%20Tools-Badges%3A%20Available%20on-9b59b6.svg?style=flat&logo=)](https://availableon.badge.ptkdev.io/) [![](https://img.shields.io/badge/%F0%9F%90%BE%20Tools-JSON%20Token%20Replace-9b59b6.svg?style=flat&logo=)](https://github.com/thingnoy/wc-datepicker/json-token-replace) [![](https://img.shields.io/badge/%F0%9F%90%8D%20Tools-ESLint%3A%20snakecasejs-9b59b6.svg?style=flat&logo=)](https://github.com/thingnoy/wc-datepicker/eslint-plugin-snakecasejs)

